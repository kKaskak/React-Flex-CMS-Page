  ...
  return (
    <div className='gpt3__whatgpt3 section__margin' id='wgpt3'>
      <motion.div initial={'hidden'} whileInView={'show'}  viewport={{ once: true }} variants={itemFirst} className='gpt3__whatgpt3-feature'>
        <Feature title="What is GPT-7" text="GPT-7 AI is an advanced natural language processing model developed by kKaskak. It is capable of generating human-like language and performing a variety of language tasks. Its capabilities have made it a popular tool among developers and businesses."/>
      </motion.div>
      <div className='gpt3__whatgpt3-heading'>
        ...
        <motion.div initial={'hidden'} whileInView={'show'} viewport={{ once: true }} variants={container} className='gpt3__whatgpt3-container'>
            ...
            <motion.span viewport={{ once: true }} variants={item}><Feature title="Knowledgebase" text="The GPT-7 AI knowledgebase is a repository of information about a wide range of topics, accessible through natural language conversation. "/></motion.span>
            <motion.span viewport={{ once: true }} variants={item}><Feature title="Education" text="GPT-7 AI can support education by providing quick answers and explanations, personalized learning, and language practice opportunities."/></motion.span>
        </motion.div>
    </div>
  )
}
